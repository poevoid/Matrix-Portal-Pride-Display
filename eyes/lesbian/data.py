...
EYE_DATA = {
    'eye_image'        : EYE_PATH + 'les-eyes.bmp',
    'upper_lid_image'  : EYE_PATH + 'les-upper-lids.bmp',
    'lower_lid_image'  : EYE_PATH + 'les-lower-lids.bmp',
    'stencil_image'    : EYE_PATH + 'les-stencil.bmp',
